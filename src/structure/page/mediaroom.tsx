        ...
        <div className={roomApps? "generic_room_dashboard" : "media_off"}>
            ...
            <div className={tvOptions? "generic_media_container" : "media_off"} id="all_source_layout" >
                    <div className={active_media? "media_off":"room_sources_container"}>
                            ...
                            <div className="source_card" id= {activeSource === 1? 'active_source' : '' } onClick={()=>playSource('media1')}>
                            ...
                            <div className="source_card" id= { activeSource === 3? 'active_source' : 'not_active' } onClick={()=>playSource('media3')}>
                                <div className="img_container">
                                    <img src={appleTV} id="svg_gray" style={{height:"50%"}}/>
                                </div>
                            ...
                            <div className="source_card" id= { activeSource === 5? 'active_source' : 'not_active' } onClick={()=>playSource('media5')}>
                                <div className="img_container">
                            ...
                            <div className="source_card" id ={ activeSource === 7? 'active_source' : 'not_active' }onClick={()=>playSource('media7')}>
                                <div className="img_container">
